...
/**
 * Shared "create a ticket" form body + footer. Rendered inside a modal by
 * <NewTicketModal> and as a full page on the client portal
 * (/client/new-ticket) — the parent owns the surrounding container/header.
 */
